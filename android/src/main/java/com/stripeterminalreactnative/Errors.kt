...
fun TerminalErrorCode.convertToReactNativeErrorCode(): String = when (this) {
    ...
    TerminalErrorCode.TAP_TO_PAY_PIN_UNAVAILABLE -> "TAP_TO_PAY_PIN_UNAVAILABLE"
    ...
    // Barcode
    TerminalErrorCode.BARCODE_SCANNER_UNAVAILABLE -> "BARCODE_SCANNER_UNAVAILABLE"
    TerminalErrorCode.BARCODE_REQUESTED_SCANNER_NOT_FOUND -> "BARCODE_REQUESTED_SCANNER_NOT_FOUND"
    TerminalErrorCode.BARCODE_SCANNING_UNSUPPORTED_DEVICE -> "BARCODE_SCANNING_UNSUPPORTED_DEVICE"
}
